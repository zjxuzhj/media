...
insert into `multmedia`  values('38','新尸骨无存 Cabin Fever (2016)','/film/8.jpg','在一个阳光明媚的日子里，凯伦（盖琦·格莱特利 Gage Golightly 饰）、保罗（塞缪尔·戴维斯 Samuel Davis 饰）、杰夫（马修·达达里奥 Matthew Daddario 饰）、玛茜（娜蒂安·克劳克 Nadine Crocker 饰）、伯特（达斯汀·英格拉姆 Dustin Ingram 饰）等五位好友来到了一个远离城市喧嚣的山林度假。男男女女尽情享受浪漫时光，脑子有点儿二的伯特则拿着半自动步枪玩耍，却不小心伤到了路人。夜幕降临，他们回到小屋休息。而就在此时，被伯特射伤的男人前来求救。伯特为了隐藏真相谎称该男子被神秘病毒感染，以致于众人下狠手将其拒之门外。这一事件彻底摧毁了他们的假期，等待几个年轻人的还有更为恐怖的事情……','0','0',now(),'30');
insert into `multmedia`  values('39','麦斯卡：死灵法师 Mythica: The Necromancer (2015)','/film/9.jpg','梅利斯特为首的囚犯和马立克势力及她的团队共同参与一项任务。','0','0',now(),'30');
insert into `multmedia`  values('40','疯狂动物城 Zootopia (2016)','/film/10.jpg','故事发生在一个所有哺乳类动物和谐共存的美好世界中，兔子朱迪（金妮弗·古德温 Ginnifer Goodwin 配音）从小就梦想着能够成为一名惩恶扬善的刑警，凭借着智慧和努力，朱迪成功的从警校中毕业进入了疯狂动物城警察局，殊不知这里是大型肉食类动物的领地，作为第一只，也是唯一的小型食草类动物，朱迪会遇到怎样的故事呢？','0','0',now(),'30');
insert into `multmedia`  values('41','小森林 冬春篇 リトル・フォレスト 冬・春 (2015)','/film/11.jpg','根据五十岚大介漫画原作拍摄的真人电影《小森林 冬春篇》公开了预告片。片中可以看到桥本爱出演的主人公市子伫立在寒冬美景中的样子。从预告片中还可以感受到她与母亲的关系、与朋友的交流，还有自己的心境。美丽的风景和市子简单的生活令人关注。','0','0',now(),'30');
