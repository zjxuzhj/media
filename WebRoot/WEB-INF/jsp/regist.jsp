...
<script type="text/javascript">
	...
	function checkUserName() {
		...
		$("#span1").load(
				"${pageContext.request.contextPath}/user_checkUserName.action?"
						+ new Date().getTime(), {
					'username' : username
				});
	}
					...
					<form id="registerForm"
								...
								<tr>
									...
									<td><input type="text" id="username" name="username"
										class="text" maxlength="20" onblur="checkUserName()"><span
											id="span1"><s:fielderror fieldName="username" /> </span></td>
								</tr>
								<tr>
						...
						<div class="login">
							...
							<dl>
								<dt>已经拥有账号了？</dt>
								<dd>
									立即登录即可体验！ <a href="./会员登录.htm">立即登录</a>
								</dd>
							</dl>
						</div>
					</form>
